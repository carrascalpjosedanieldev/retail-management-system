...
public class MenuUtilizarTienda {
    ...
    private static void venderProductoDeInventario(Scanner sc, ControladorTienda controladorTienda){
        ...
        while (atenderCliente.equalsIgnoreCase("Si")){
            ...
            try {
                ...
                System.out.println("Venta Rechazada\nERROR:  " + e.getMessage());
            } catch (InventarioNoEncontradoException | StockInsuficienteException | ProductoNoEncontradoException | ServicioNoEncontradoException | CapacidadExcedidaException e) {
    ...
    private static SolicitudItem capturarDatosDeCompra(Scanner sc){
